...
export default function Dashboard() {
  ...
  useEffect(() => { predict(selected); }, [selected]); // eslint-disable-line
  ...
  return (
    <div style={{ maxWidth: 1100, margin: "0 auto", padding: "28px 20px 80px" }}>
      <div style={{ marginBottom: 24 }}>
        <h1 style={{ fontSize: 26, fontWeight: 700, letterSpacing: -0.5, marginBottom: 4 }}>Signal Dashboard</h1>
        <p style={{ color: "#64748b", fontSize: 14 }}>AI-powered crypto price predictions with technical analysis</p>
      </div>
      ...
      {loading && (
        <div style={{ display:"flex", alignItems:"center", gap:10, color:"#64748b", padding:"12px 0", fontSize:13 }}>
          ...
          Fetching {selected} data and running prediction model…
        </div>
      )}
      {error && !loading && (
